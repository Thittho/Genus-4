...
// Computes the degree m invariants which are products of invariants of smaller degrees
...
// Evaluates a secondary invariant on one form and its "mirror" form
...
// Evaluates a symmetric and an antisymmetric secondary invariant on one form
...
// Computes the invariants of a given degree that are a product of elements from the HSOP
function EvaluationInvariantsHsop(list_valued, forms, d, borne)
...
function EvaluationInvariantsOthers(list_valued_hsop, list_valued_others, inv_sec, forms, d, n, borne)// To evaluate the products of hsop and secondary
	list_deg_hsop := [6,6,8,8,10,12,14];
...
function Invariants(f)
	...
	invHSOP := [K | I61,I62,I81,I82,I10,I12,I14];
...
// Given a degree n, returns a set of secondary invariants for this degree such that they form a basis, together with products of smaller degree invariants. 
function invariants_secondaires_non_sym(inv_sec, forms, list_valued_hsop, list_valued_others, list_valued_inv_sec, L, n)
	m := L[n+1];
	list_deg := [6,8,8,10,10,10,10,10,10,12,12,12,12,12,12,12,12,12,14,14,14,14,14,14,14,14,14,14,14,14,16,16,16,16,16,16,16,16,16,16,16,16,16,16,18,18,18,18,18,18,18,18,18,18,18,6,8,10,10,10,12,12,12,12,12,14,14,14,14,14,14,14,14,14,16,16,16,16,16,16,16,16,16,16,16,16,18,18,18,18,18,18,18,18,18,20,22,24];
	M_sym, M_non_sym := EvaluationInvariantsHsop(list_valued_hsop, forms, n, m+10);
	for d in [6..n-6] do
		if d mod 2 eq 0 then
			M0_sym, M0_non_sym := EvaluationInvariantsOthers(list_valued_hsop, list_valued_others, inv_sec, forms, d, n, m+10);
